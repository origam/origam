...
fill_origam_settings_config() {
    ...
    if [[ "$database_type" == "mssql" ]]; then
      local connection_string="Encrypt=True;TrustServerCertificate=False;Data Source=${OrigamSettings__DatabaseHost},${OrigamSettings__DatabasePort};Initial Catalog=${OrigamSettings__DatabaseName};User ID=${OrigamSettings__DatabaseUsername};Password=${OrigamSettings__DatabasePassword};"
