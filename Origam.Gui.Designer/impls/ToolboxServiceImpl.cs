...
namespace Origam.Gui.Designer
{
	...
	public class ToolboxServiceImpl : System.Drawing.Design.IToolboxService
	{
		...
		{
			ModelToolboxItem result = (ModelToolboxItem)((DataObject)serializedObject).GetData(typeof(ModelToolboxItem));
			return result;
		}
		...
		public bool SetCursor()
		{
            if (toolbox.SelectedTool != null 
                && toolbox.SelectedTool.DisplayName != "<Pointer>") // <Pointer> is not a tool.
			{
