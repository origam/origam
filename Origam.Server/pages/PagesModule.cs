...
namespace Origam.Server.Pages
{
    public class PagesModule : IHttpModule
    {
            ...
            try
            {
                ...
                if (page != null)
                {
                    ...
                    else
                    {
                        ...
                        context.Response.Cache.SetMaxAge(TimeSpan.FromSeconds(maxAge));
                    }
        ...
        private static IPageRequestHandler HandlePage(AbstractPage page)
        {
			...
			{
                throw new ArgumentOutOfRangeException("page", page, Properties.Resources.ErrorUnknownPageType);
            }
            return handler;
        }

        private static Dictionary<string, object> MapParameters(HttpContext context, Dictionary<string, string> urlParameters, AbstractPage page, string requestMimeType)
        {
        ...
        private static void MapOtherParameters(HttpContext context, Dictionary<string, string> urlParameters, 
            ...
            string requestMimeType)
        {
            ...
            switch (ppm.MappedParameter)
            {
                ...
                case "Server_BrowserName":
                    systemParameterValue = context.Request.Browser.Browser;
                    break;
                case "Server_BrowserVersion":
                    systemParameterValue = context.Request.Browser.Version;
                    break;
        ...
        private static void MapFileToParameter(HttpContext context, Dictionary<string, object> mappedParameters, PageParameterMapping ppm, PageParameterFileMapping fileMapping)
        {
            HttpPostedFile file = context.Request.Files[ppm.MappedParameter];
        ...
        private static void MapContentToParameter(HttpContext context,
        ...
        private static AbstractPage ResolvePage(HttpContext context, out Dictionary<string, string> urlParameters)
        {
        ...
        private static bool IsPageValidByVerb(AbstractPage page, HttpContext context)
        {
