...
{
    public class NetFxHttpTools : IHttpTools
    {
        public void WriteFile(IRequestWrapper request, IResponseWrapper response, byte[] file, string fileName, bool isPreview)
        {
            WriteFile(request, response, file, fileName, isPreview, null);
        }

        public void WriteFile(IRequestWrapper request, IResponseWrapper response, byte[] file, string fileName, bool isPreview, string overrideContentType)
        {
