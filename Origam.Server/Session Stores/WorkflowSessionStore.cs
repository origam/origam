...
{
    class WorkflowSessionStore : SaveableSessionStore
    {
        ...
        public WorkflowSessionStore(UIService service, UIRequest request, Guid workflowId, string name)
        ...
        public object ExecuteAction(string actionId, IList<string> cachedFormIds)
        {
            ...
            {
                throw new Exception(Properties.Resources.ErrorCommandInProgress);
            }
            ...
            try
            {
                switch (actionId)
                {
                    ...
                    default:
                        throw new ArgumentOutOfRangeException("actionId", actionId, Properties.Resources.ErrorContextUnknownAction);
                }
            }
            finally
            {
        ...
        private void HandleWorkflow(WorkflowCallbackHandler handler)
        {
            ...
            if (handler.Result.Exception != null)
            {
                ...
                this.RuleSet = null;
                this.StepDescription = Properties.Resources.WorkflowErrorTitle;
                this.EndRule = null;
            ...
            else
            {
                ...
                this.FormId = new Guid(Origam.OrigamEngine.ModelXmlBuilders.FormXmlBuilder.WORKFLOW_FINISHED_FORMID);
                this.RuleSet = null;
                this.StepDescription = Properties.Resources.WorkflowFinishedTitle;
                this.EndRule = null;
                this.DataStructure = null;
                this.DataStructureId = Guid.Empty;
                this.SortSet = null;
                ...
                this.TaskId = Guid.Empty;
                this.WorkflowInstanceId = handler.Result.Engine.WorkflowInstanceId;
                this.FinishMessage = (handler.Result.Engine.ResultMessage == "" ? Properties.Resources.WorkflowFinished : handler.Result.Engine.ResultMessage);
                this.IsFinalForm = true;
                this.AllowSave = false;
                this.IsAutoNext = false;
                this.ConfirmationRule = null;
        ...
        private RuleExceptionDataCollection EvaluateEndRule()
        {
            if (this.Data.HasErrors)
            {
                ...
                {
                    log.Debug(Properties.Resources.ErrorInForm);
                    log.Debug(DebugClass.ListRowErrors(Data));
                }
                throw new Exception(Properties.Resources.ErrorInForm);
            }
        ...
        {
            if (! this.IsFirstSaveDone) throw new Exception(Properties.Resources.ErrorCannotRefreshFormNotSaved);
