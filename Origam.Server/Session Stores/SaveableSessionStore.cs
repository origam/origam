...
namespace Origam.Server
{
    public abstract class SaveableSessionStore : SessionStore
    {
        ...
        public SaveableSessionStore(UIService service, UIRequest request, string name)
            ...
            IDictionary<string, object> parameters, string requestingGrid)
        {
            ...
            else
            {
                ...
                {
                    key = Origam.Gui.Win.FormGenerator.AddTemplateRecord(null, this.Template, entity, this.DataStructureId, this.Data);
                }
                else
                {
                    ...
                    key = Origam.Gui.Win.FormGenerator.AddTemplateRecord(parentRow, this.Template, entity, this.DataStructureId, this.Data);
                }
                    ...
                    foreach(Guid dependentColumnId in _entityFieldDependencies[dsEntityId][fieldId])
                    {
                        ...
                        catch (NullReferenceException e) 
                        {
                            throw new NullReferenceException(
                                String.Format(Properties.Resources.ErrorDependentColumnNotFound,
