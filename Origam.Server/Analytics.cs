...
namespace Origam.Server
{
    ...
    {
        private static readonly ILog perfLog = LogManager.GetLogger("Analytics");
        public const string PropertyNamePrefix = "log4net_app_";

        #region Factory methods

        private static AdaptivePropertyProvider<T> Create<T>(string propertyName, T propertyValue)
        {
