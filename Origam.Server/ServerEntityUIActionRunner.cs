...
{
    internal class ServerEntityUIActionRunner: EntityUIActionRunner
    {
        ...
        public ServerEntityUIActionRunner(IEntityUIActionRunnerClient actionRunnerClient,
            UIManager uiManager, SessionManager sessionManager, UIService uiService,
            ReportManager reportManager) : base(actionRunnerClient)
        {
            ...
            ExecuteActionProcessData processData)
        {
            ...
            {
                throw new Exception(Properties.Resources.ErrorWorkQueueCommandNotFound);
            }
                    ...
                    foreach (WorkQueueWorkflowCommandParameterMapping pm in cmd.ParameterMappings)
                    {
                        ...
                        switch (pm.Value)
                        {
                            ...
                            case WorkQueueCommandParameterMappingType.Parameter2:
                                ...
                                break;
                            default:
                                throw new ArgumentOutOfRangeException("Value", pm.Value, Properties.Resources.ErrorUnknownWorkQueueCommandValueType);
                        }
        ...
        private void ExecuteReportAction(ExecuteActionProcessData processData)
        {
                ...
                || processData.Action.Mode != PanelActionMode.Always)
            {
                ...
                {
                    throw new Exception(Properties.Resources.ErrorChangeUIMultipleRecords);
                }
            }
