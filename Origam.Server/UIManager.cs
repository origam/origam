...
namespace Origam.Server
{
    internal class UIManager
    {
        ...
        internal UIManager(int initialPageNumberOfRecords,
        ...
        internal UIResult InitUI(UIRequest request, bool registerSession,
            ...
            UIService uiService)
        {
            ...
            {
                ss = sessionManager.CreateSessionStore(request, uiService);
