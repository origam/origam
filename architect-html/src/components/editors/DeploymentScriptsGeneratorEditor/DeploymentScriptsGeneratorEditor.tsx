...
const DeploymentScriptsGeneratorEditor = ({
  editorState,
}: {
  editorState: DeploymentScriptsGeneratorEditorState;
}) => {
  return (
                  ...
                  <table className={S.resultsTable}>
                    <thead>
                      <tr>
                        ...
                        <th>{T('Script2', 'editor_DeploymentScriptsGenerator_Column_Script2')}</th>
                      </tr>
                    </thead>
                    <tbody>
