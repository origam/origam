...
//{
//
//    public class InternalReportService: IReportService
//    {
...
//
//        #region Constructors
//        public InternalReportService(Dictionary<Guid, PortalSessionStore> portalSessions,
//            Dictionary<Guid, SessionStore> formSessions, IReportManager reportManager,
...
//
//
//            this.sessionManager = sessionManager;// new SessionManager(portalSessions, formSessions);
//            uiManager = new UIManager(INITIAL_PAGE_NUMBER_OF_RECORDS,sessionManager);
//            this.reportManager = reportManager;// new ReportManager(sessionManager);
//        }
//
//        #endregion
//
...
//            GlobalValueStore.Instance.Add(key, new AttachmentRequest(ids, isPreview));
//
...
//            GlobalValueStore.Instance.Add(key, info);
...
//            GlobalValueStore.Instance.Add(key, new SearchRequest(searchString, SecurityManager.CurrentPrincipal));
//
...
//                    GlobalValueStore.Instance.Add(key, new AttachmentUploadRequest(recordId, entityId, SecurityManager.CurrentPrincipal));
...
//            GlobalValueStore.Instance.Add(key,
//                new BlobUploadRequest(row, SecurityManager.CurrentPrincipal, parameters, dateCreated, dateLastModified,
//                    property));
...
//            GlobalValueStore.Instance.Add(key, new BlobDownloadRequest(row, parameters, property, isPreview));
