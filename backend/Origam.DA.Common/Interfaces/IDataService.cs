...
public interface IDataService : IDisposable
{
    ...
    IEnumerable<IEnumerable<object>> ExecuteDataReader(DataStructureQuery dataStructureQuery);
    IEnumerable<Dictionary<string, object>> ExecuteDataReaderReturnPairs(DataStructureQuery query);
