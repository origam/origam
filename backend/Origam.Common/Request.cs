...
namespace Origam
{
    ...
    public Request(string url, string method, string content = null,
        ...
        int? timeout = null, bool throwExceptionOnError = true, CookieCollection cookies = null,
        ...
        public override int GetHashCode()
        {
            ...
            hashCode = hashCode * -1521134295 + EqualityComparer<CookieCollection>.Default.GetHashCode(Cookies);
