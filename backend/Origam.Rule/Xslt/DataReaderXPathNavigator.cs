...
public class DataReaderXPathNavigator : XPathNavigator
{
        ...
        get
        {
                ...
                if(fieldType == typeof(int))
                {
                    return XmlConvert.ToString(
                        dataReader.GetInt32(position - 1));
                }
                else if(fieldType == typeof(Guid))
                {
                    return XmlConvert.ToString(
                        dataReader.GetGuid(position - 1));
                }
                ...
                {
                    return XmlConvert.ToString(
                        dataReader.GetDecimal(position - 1));
                }
                else if(fieldType == typeof(bool))
                {
                    return XmlConvert.ToString(
                        dataReader.GetBoolean(position - 1));
                }
    ...
    public override bool MoveTo(XPathNavigator other)
    {
            ...
            wasMoveToFirstChildInvoked 
                = (other as DataReaderXPathNavigator).wasMoveToFirstChildInvoked;
