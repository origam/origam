...
public class MIMETypes
{
    ...
    public static string GetContentTransferEncoding(string strBuffer, int pos)
    {
        ...
        if (begin != -1)
        {
            ...
            return strBuffer
                .Substring(
                    begin + Content_Transfer_Encoding_Tag.Length + 1,
                    end - begin - Content_Transfer_Encoding_Tag.Length
                )
                .Trim();
        }
        else
    ...
    public static string GetContentCharset(string strBuffer, int pos)
    {
        ...
        if (begin != -1)
        {
            ...
            string result = strBuffer
                .Substring(
                    begin + Content_Transfer_Charset_Tag.Length + 1,
                    end - begin - Content_Transfer_Charset_Tag.Length
                )
                .Trim();
