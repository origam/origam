...
public class AsReportPanel : System.Windows.Forms.UserControl, IAsDataConsumer, IOrigamMetadataConsumer
{
	...
	protected override void Dispose( bool disposing )
	{
		if( disposing )
		{
			this.pnlToolbar.ReportRefreshRequested -= new System.EventHandler(this.pnlToolbar_ReportRefreshRequested);
	...
	{
		System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(AsReportPanel));
		...
		// btnInitialRefresh
		// 
		this.btnInitialRefresh.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
		...
		this.btnInitialRefresh.Image = ((System.Drawing.Image)(resources.GetObject("btnInitialRefresh.Image")));
...
//			}
	...
	private void SetReportText()
	{
		...
		{
			pnlToolbar.Caption = (this.CrystalReport.Caption == null | this.CrystalReport.Caption == "" ? this.CrystalReport.Name : this.CrystalReport.Caption);
			btnTisk.Text = (this.CrystalReport.Caption == null | this.CrystalReport.Caption == "" ? this.CrystalReport.Name : this.CrystalReport.Caption);
		}
	}
	...
	private Hashtable GetParameters (CurrencyManager cm)
	{
		...
		foreach(ColumnParameterMapping colMap in ParameterMappings)
		{
			if(colMap.ColumnName != "" && colMap.ColumnName != null) // maybe the parameter was not bound, we let report service to try the default value
			{
				...
				{
					throw new ArgumentOutOfRangeException("ColumnName", colMap.ColumnName, Origam.BI.CrystalReports.ResourceUtils.GetString("ErrorBindParam"));
				}
			}
		}
	...
	private void PrintReport()
	{
		...
		{
			Origam.UI.AsMessageBox.ShowError(this.FindForm(), ex.Message, Origam.BI.CrystalReports.ResourceUtils.GetString("ErrorReportShow", this.CrystalReport.Name), ex);
		}
		finally
		{
	...
	{
		if(ParameterMappings.Count > 0 && !(_bindMan != null && _bindMan.Count > 0 && _bindMan.Position >= 0))
		{
			SetButtons(this._buttonsOnly);

			throw new InvalidOperationException(Origam.BI.CrystalReports.ResourceUtils.GetString("ErrorReportNoRecord0") + Environment.NewLine + Environment.NewLine +
			                                    Origam.BI.CrystalReports.ResourceUtils.GetString("ErrorReportNoRecord1") + Environment.NewLine +
			                                    Origam.BI.CrystalReports.ResourceUtils.GetString("ErrorReportNoRecord2") + Environment.NewLine +
			                                    Origam.BI.CrystalReports.ResourceUtils.GetString("ErrorReportNoRecord3") + Environment.NewLine +
	...
	private void RefreshReport()
	{
		if(this.CrystalReport == null)
		{
			Origam.UI.AsMessageBox.ShowError(this.FindForm(), 
				Origam.BI.CrystalReports.ResourceUtils.GetString("ErrorReportPanelDefinition"), 
				Origam.BI.CrystalReports.ResourceUtils.GetString("ReportShowTitle", this.FindForm().Text), null);
			return;
		}
		...
		{
			Origam.UI.AsMessageBox.ShowError(this.FindForm(), ex.Message,
				Origam.BI.CrystalReports.ResourceUtils.GetString("ErrorReportRefresh", this.CrystalReport.Name), ex);
		}
		finally
		{
			this.HideProgress();
	...
	{
		btnInitialRefresh.SetBounds((this.Width / 2) - (btnInitialRefresh.Width / 2), (this.Height / 2) - (btnInitialRefresh.Height / 2), btnInitialRefresh.Width, btnInitialRefresh.Height, BoundsSpecified.Location);
	}
