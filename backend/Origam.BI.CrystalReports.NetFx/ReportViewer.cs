...
public class ReportViewer : AbstractViewContent
{
    ...
    public ReportViewer(CrystalReport reportElement, string titleName)
        : this()
    {
    ...
    {
        get { return (_reportElement != null); }
        set { base.CanRefreshContent = value; }
    }
    ...
    {
        get { return crViewer.ReportSource; }
        set
        {
            ClearReportSource();
