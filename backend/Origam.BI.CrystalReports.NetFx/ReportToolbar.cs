...
public class ReportToolbar : System.Windows.Forms.UserControl
{
    ...
    protected override void Dispose(bool disposing)
    {
        if (_crViewer != null)
        {
            _crViewer.Navigate -= new CrystalDecisions.Windows.Forms.NavigateEventHandler(
                value_Navigate
            );
        }
    ...
    private void InitializeComponent()
    {
        ...
        this.pnlToolbar.PanelIcon = (
            (System.Drawing.Bitmap)(resources.GetObject("pnlToolbar.PanelIcon"))
        );
        ...
        // zoomMenu
        //
        this.zoomMenu.MenuItems.AddRange(
        ...
        this.txtFindText.KeyDown += new System.Windows.Forms.KeyEventHandler(
            this.txtFindText_KeyDown
        );
        ...
        this.toolBar1.Buttons.AddRange(new System.Windows.Forms.ToolBarButton[] { this.btnFind });
    ...
    {
        get { return this.pnlToolbar.PanelTitle; }
        set { this.pnlToolbar.PanelTitle = value; }
    }
    public Color StartColor
    {
        get { return this.pnlToolbar.StartColor; }
        set { this.pnlToolbar.StartColor = value; }
    }
    public Color MiddleEndColor
    {
        get { return this.pnlToolbar.MiddleEndColor; }
        set { this.pnlToolbar.MiddleEndColor = value; }
    }
    public Color MiddleStartColor
    {
        get { return this.pnlToolbar.MiddleStartColor; }
        set { this.pnlToolbar.MiddleStartColor = value; }
    }
    public Color EndColor
    {
        get { return this.pnlToolbar.EndColor; }
        set { this.pnlToolbar.EndColor = value; }
    }
    ...
    )
    {
        ...
        else if (e.Button == btnGroupTree)
        {
            ...
            {
                ReportViewer.ToolPanelView = CrystalDecisions
                    .Windows
                    .Forms
                    .ToolPanelViewType
                    .GroupTree;
