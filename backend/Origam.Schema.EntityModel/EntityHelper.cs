...
public static class EntityHelper
{
    public static FieldMappingItem CreateForeignKey(
        ...
        string caption,
        bool allowNulls,
        IDataEntity masterEntity,
        IDataEntity foreignEntity,
        IDataEntityColumn foreignField,
        IDataLookup lookup,
        bool persist
    )
    {
    ...
    public static IDataEntity DefaultAncestor
    {
        get
        {
            ...
            foreach (var abstractSchemaItem in entityModelSchemaItemProvider.ChildItems)
            {
    ...
    public static IDataEntityColumn DefaultPrimaryKey
    {
        get
        {
            foreach (IDataEntityColumn dataEntityColumn in DefaultAncestor.EntityColumns)
            {
                if (dataEntityColumn.IsPrimaryKey && !dataEntityColumn.ExcludeFromAllFields)
                {
    ...
    )
    {
        ...
        else
        {
            ...
            {
                databaseParameter.MappedDataType = mappableDataType.MappedDataType;
            }
    ...
    public static DataEntityIndex CreateIndex(
        IDataEntity entity,
        IDataEntityColumn field,
        bool unique,
        bool persist
