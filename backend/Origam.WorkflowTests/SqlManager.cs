...
{
    public static readonly Guid TestQueue1 = new(g: "751BD582-2604-4259-B560-6AFB8A772FCA");
    public static readonly Guid TestQueue2 = new(g: "5AB2B7E6-1181-4CA2-8EB3-39DF505D8EB3");
    public static readonly Guid TestQueue3 = new(g: "E776D7F7-482D-4AFF-B32A-444A9A9959E5");
    public static readonly Guid FailingQueue = new(g: "0AB10C2F-386E-4DD1-992E-5E3765A28447");
    public static readonly Guid RetryQueue = new(g: "8527E8C1-D480-4B12-81A6-F3858B37DC73");
    public static readonly Guid ErrorQueue = new(g: "6584869B-8FD6-44E6-A6C9-5C03D2555A2C");
    public static readonly Guid FailingEntryId = new(g: "0A4B2890-D0D6-4599-A92A-A5E79BA5DCC7");
...
public static class SqlManagerFactory
{
    public static SqlManager Create(ICoreDataService coreDataService, IDataService dataService)
    {
        ...
        {
            return new MsSqlManager(dataService: coreDataService);
        }

        if (dataService is MonitoredPgSqlDataService)
        {
            return new PgSqlManager(dataService: coreDataService);
        }
