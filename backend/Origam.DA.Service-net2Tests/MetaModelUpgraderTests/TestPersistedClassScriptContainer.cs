...
class TestTestRenamedClassScriptContainer : UpgradeScriptContainer
{
    ...
    public override List<string> OldFullTypeNames { get; } =
        new List<string> { "Origam.DA.ServiceTests.TestOldNameClass" };
    public override string[] OldPropertyXmlNames { get; }
    ...
    public TestDeadClassScriptContainer()
    {
        ...
        upgradeScripts.Add(
            new UpgradeScript(
                ...
                (node, doc) =>
                {
                    XNamespace tdcNamespace = doc.FindClassNamespace(
                        "Origam.DA.ServiceTests.TestDeadClass"
                    );
                    ...
                    doc.FileElement.SetAttributeValue(
                        XNamespace.Xmlns.GetName("tpc"),
                        tpcNamespace
                    );
