...
public class MetaModelUpgraderTests : ClassUpgradeTestBase
{
    ...
    public void ShouldUpgradeByOneVersion()
    {
        ...
        var sut = new MetaModelAnalyzer(
            new NullFileWriter(),
            new MetaModelUpgrader(GetType().Assembly)
        );
        sut.TryUpgrade(xFileData);

        XNamespace tpcNamespace =
            "http://schemas.origam.com/Origam.DA.ServiceTests.TestPersistedClass/6.0.2";
        XNamespace tbcNamespace =
            "http://schemas.origam.com/Origam.DA.ServiceTests.TestBaseClass/6.0.1";
        ...
        Assert.True(
            classNode.Attribute(tbcNamespace.GetName("TestBaseClassProperty")).Value == "5"
        );
        ...
        Assert.That(
            ...
            Is.EqualTo(tpcNamespace.ToString())
        );
        Assert.That(
            fileElement.Attribute(XNamespace.Xmlns.GetName("tbc"))?.Value,
            Is.EqualTo(tbcNamespace.ToString())
        );
    }
    ...
    public void ShouldReplaceClass()
    {
        ...
        bool classNamespacesPresent = xFileData.Document.Namespaces.Any(nameSpace =>
            nameSpace.FullTypeName.Contains("TestDeadClass")
        ...
        Assert.That(
            classNode.Attribute(tpcNamespace.GetName("name"))?.Value,
            Is.EqualTo("test v0")
        ); // "test v0" was value of the dead class's name property
        Assert.That(
            fileElement.Attribute(XNamespace.Xmlns.GetName("tpc"))?.Value,
            Is.EqualTo(tpcNamespace.ToString())
        );
    ...
    public void ShouldRemoveDeadBaseClass()
    {
        ...
        XNamespace tbcNamespace =
            "http://schemas.origam.com/Origam.DA.ServiceTests.TestBaseClass/6.0.1";
        XNamespace deadNamespace =
            "http://schemas.origam.com/Origam.DA.ServiceTests.TestDeadBaseClass/6.0.1";
        XElement fileElement = xFileData.Document.FileElement;
        XElement classNode = xFileData.Document.ClassNodes.First();
    ...
    public void ShouldUpgradeRenamedClass()
    {
        ...
        XNamespace toncNamespace =
            "http://schemas.origam.com/Origam.DA.ServiceTests.TestOldNameClass/6.0.0";
        XNamespace trcNamespace =
        ...
        Assert.That(
            fileElement.Attribute(XNamespace.Xmlns.GetName("trc"))?.Value,
            Is.EqualTo(trcNamespace.ToString())
        );
    }
    ...
    public void ShouldUpgradeRenamedClassWithChild()
    {
        ...
        Assert.That(fileElement.Attribute(XNamespace.Xmlns.GetName("tonc"))?.Value, Is.Null);
        Assert.That(
            renamedClassNode.Attribute(trcNamespace.GetName("name"))?.Value,
            Is.EqualTo("test")
        );
        Assert.That(
            fileElement.Attribute(XNamespace.Xmlns.GetName("trc"))?.Value,
        ...
        Assert.True(
            childClassNode.Attribute(tbcNamespace.GetName("TestBaseClassProperty")) != null
        );
        Assert.True(
            childClassNode.Attribute(tbcNamespace.GetName("TestBaseClassProperty")).Value == "5"
        );
