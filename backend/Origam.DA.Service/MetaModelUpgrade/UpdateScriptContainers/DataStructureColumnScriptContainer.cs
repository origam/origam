    ...
    public DataStructureColumnScriptContainer()
    {
        upgradeScripts.Add(
            new UpgradeScript(
                ...
                (node, doc) =>
                {
                    XNamespace oldNameSpace =
                        "http://schemas.origam.com/Origam.Schema.EntityModel.DataStructureColumn/6.0.0";
                    XNamespace newNameSpace =
                        "http://schemas.origam.com/Origam.Schema.EntityModel.DataStructureColumn/6.0.1";
