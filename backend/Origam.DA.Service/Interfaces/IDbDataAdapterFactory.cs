...
public interface IDbDataAdapterFactory : ICloneable, IDisposable
{
    ...
    DbDataAdapter CreateDataAdapter(SelectParameters adParameters, bool forceDatabaseCalculation);
