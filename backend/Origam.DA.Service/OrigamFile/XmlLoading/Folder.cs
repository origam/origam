...
public class Folder
{
    ...
    public bool IsParentOf(Folder other) => dirInfo.IsOnPathOf(other.dirInfo);

    private bool Equals(Folder other) => string.Equals(dirInfo.FullName, other.dirInfo.FullName);
