...
/// toolbox control.
public class ToolboxServiceImpl : System.Drawing.Design.IToolboxService
{
    private IDesignerHost host;
    private ToolboxPane toolbox;

    public ToolboxServiceImpl(IDesignerHost host)
    {
        this.host = host;
    ...
    void System.Drawing.Design.IToolboxService.AddLinkedToolboxItem(
        ToolboxItem toolboxItem,
        System.ComponentModel.Design.IDesignerHost host
    )
    {
    ...
    ToolboxItem System.Drawing.Design.IToolboxService.DeserializeToolboxItem(
        object serializedObject
    )
    {
    ...
    void System.Drawing.Design.IToolboxService.AddCreator(
        System.Drawing.Design.ToolboxItemCreatorCallback creator,
        string format
    )
    {
    ...
    public bool IsSupported(
        object serializedObject,
        System.Collections.ICollection filterAttributes
    )
    {
        return true;
    }
    ...
    /// We are always using standard ToolboxItems, so they are always supported.
    bool System.Drawing.Design.IToolboxService.IsSupported(
        object serializedObject,
        System.ComponentModel.Design.IDesignerHost host
    )
    {
    ...
    {
        get { return toolbox.SelectedCategory; }
        set
        {
