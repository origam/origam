...
internal class SelectionServiceImpl : ISelectionService
{
    ...
    internal SelectionServiceImpl(IDesignerHost host)
    {
        ...
        if (cs != null)
        {
            ...
            cs.ComponentChanged += new ComponentChangedEventHandler(
                this.DesignerHost_ComponentChanged
            );
        }
    ...
    object ISelectionService.PrimarySelection
    {
        get
        {
            ...
            {
                IDictionaryEnumerator selections = (IDictionaryEnumerator)
                    selectionsByComponent.GetEnumerator();
    ...
    )
    {
        ...
        if (
            (selectionType & SelectionTypes.Normal) == SelectionTypes.Normal
