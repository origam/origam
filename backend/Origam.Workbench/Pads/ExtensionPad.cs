	...
	private void toolBar1_ButtonClick(object sender, System.Windows.Forms.ToolBarButtonClickEventArgs e)
	{
			if(e.Button == tbrNew)
			{
				...
				if(addPackageDialog.ShowDialog() == DialogResult.OK)
				{
                    ...
                    PackageHelper.CreatePackage(packageName, packageId, new Guid("147FA70D-6519-4393-B5D0-87931F9FD609"));
                    LoadPackages();
			...
			if(e.Button == tbrRemove)
			{
				...
				{
					if(MessageBox.Show(this, "Do you really want to remove the package '" + SelectedExtension.Name + "'?",
						"Remove Package", 
					...
					{
                        IPersistenceService persistenceService = ServiceManager.Services.GetService(typeof(IPersistenceService)) as IPersistenceService;
                        persistenceService.SchemaProvider.DeletePackage((Guid)SelectedExtension.PrimaryKey["Id"]);
						LoadPackages();
                    }
				}
			}
