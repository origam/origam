...
public class DocumentationPad : AbstractPadContent
{
    ...
    private void InitializeComponent()
    {
        ...
        System.ComponentModel.ComponentResourceManager resources =
            new System.ComponentModel.ComponentResourceManager(typeof(DocumentationPad));
        ...
        this.documentationComplete.SchemaSerializationMode = System
            .Data
        ...
        this.dataGridTableStyle1.GridColumnStyles.AddRange(
            new System.Windows.Forms.DataGridColumnStyle[] { this.colCategory, this.colText }
        );
        ...
        // tblCategory
        //
        this.tblCategory.Columns.AddRange(
            new System.Data.DataColumn[] { this.categoryNameTableColumn }
        );
        ...
        this.toolBar.Buttons.AddRange(new System.Windows.Forms.ToolBarButton[] { this.butRefresh });
        ...
        this.dsCategories.Tables.AddRange(new System.Data.DataTable[] { this.tblCategory });
        //
        // DocumentationPad
        //
    ...
    private void _cm_CurrentChanged(object sender, EventArgs e)
    {
        ...
        {
            DocumentationComplete.DocumentationRow row =
                (cm.Current as DataRowView).Row as DocumentationComplete.DocumentationRow;
            row.Id = Guid.NewGuid();
