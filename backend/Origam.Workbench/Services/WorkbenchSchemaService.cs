...
public class WorkbenchSchemaService : SchemaService
{
    ...
    {
        get { return _schemaBrowser; }
        set
        {
            if (_schemaBrowser != null)
            {
                _schemaBrowser.EbrSchemaBrowser.NodeClick -= new EventHandler(
                    ebrSchemaBrowser_NodeClick
                );
                _schemaBrowser.EbrSchemaBrowser.NodeDoubleClick -= new EventHandler(
                    ebrSchemaBrowser_NodeDoubleClick
                );
            }
    ...
    {
        get { return _schemaListBrowser; }
        set { _schemaListBrowser = value; }
    }
    public ContextMenuStrip SchemaContextMenu
    {
        get { return _schemaBrowser.EbrSchemaBrowser.ContextMenuStrip; }
        set { _schemaBrowser.EbrSchemaBrowser.ContextMenuStrip = value; }
    }
    ...
    public IBrowserNode2 ActiveNode
    {
        get
        {
            AbstractViewContent viewContent =
                WorkbenchSingleton.Workbench.ActiveDocument as AbstractViewContent;
            if (viewContent != null && viewContent.Focused && viewContent is IBrowserNode2)
            {
    ...
    protected override void SchemaProvider_InstancePersisted(
        object sender,
