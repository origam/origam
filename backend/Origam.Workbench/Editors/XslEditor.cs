...
public class XslEditor : AbstractEditor, IToolStripContainer
{
    ...
    public override List<ToolStrip> GetToolStrips(int maxWidth) =>
        new List<ToolStrip> { toolStrip };
    ...
    public XslEditor()
    {
        ...
        cboSourceStructure.SelectedValueChanged += cboSourceStructure_SelectedValueChanged;
    ...
    private void InitializeComponent()
    {
        ...
        this.cboDataStructure.AutoCompleteSource = System
            .Windows
            .Forms
            .AutoCompleteSource
            .ListItems;
        ...
        // cboSourceStructure
        //
        this.cboSourceStructure.Anchor = (
            (System.Windows.Forms.AnchorStyles)(
                (
                    (System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left)
                    | System.Windows.Forms.AnchorStyles.Right
        ...
        this.cboSourceStructure.AutoCompleteSource = System
            .Windows
            .Forms
            .AutoCompleteSource
            .ListItems;
        ...
        this.cboTraceLevel.SelectedIndexChanged += new System.EventHandler(
            this.cboTraceLevel_SelectedIndexChanged
        );
        //
        // lblTraceLevel
        //
    ...
    private void cboDataStructure_SelectedValueChanged(object sender, EventArgs e)
    {
        if (!_isEditing & !this.IsViewOnly)
        {
            if (ModelContent is XslRule)
            {
                (ModelContent as XslRule).Structure =
                    cboDataStructure.SelectedItem as IDataStructure;
                this.IsDirty = true;
            }
