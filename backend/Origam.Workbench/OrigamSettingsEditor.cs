...
public class OrigamSettingsEditor : AbstractViewContent
{
    ...
    private void InitializeComponent()
    {
        ...
        this.lvwConfigurations.SelectedIndexChanged += new System.EventHandler(
            this.lvwConfigurations_SelectedIndexChanged
        );
        //
        // colName
        //
        ...
        this.toolbar.Buttons.AddRange(
            new System.Windows.Forms.ToolBarButton[] { this.btnAdd, this.btnDelete, this.btnClone }
        );
        ...
        this.Closing += new System.ComponentModel.CancelEventHandler(
            this.OrigamSettingsEditor_Closing
        );
    ...
    private void OrigamSettingsEditor_Closing(
        object sender,
    ...
    private void lvwConfigurations_SelectedIndexChanged(object sender, System.EventArgs e)
    {
        ...
        if (lvwConfigurations.SelectedItems.Count > 0)
        {
            OrigamSettings[] selectedSettings = new OrigamSettings[
                lvwConfigurations.SelectedItems.Count
            ];
            int i = 0;
