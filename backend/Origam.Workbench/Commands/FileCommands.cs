    ...
    public override bool IsEnabled
    {
        get
        {
            ...
            return WorkbenchSingleton.Workbench.ActiveDocument != null
                && WorkbenchSingleton.Workbench.ActiveDocument.IsViewOnly == false; // && WorkbenchSingleton.Workbench.ActiveDocument.IsDirty;
        }
        set
        {
...
public class RefreshContent : AbstractMenuCommand
{
    public override bool IsEnabled
    {
        ...
        {
            return WorkbenchSingleton.Workbench.ActiveDocument != null
                && WorkbenchSingleton.Workbench.ActiveDocument.CanRefreshContent;
        }
        set
        {
            throw new ArgumentException(ResourceUtils.GetString("ErrorSetProperty"), "IsEnabled");
