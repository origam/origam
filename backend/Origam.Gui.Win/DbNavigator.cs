...
public class DbNavigator : System.Windows.Forms.Panel
{
    ...
    private void InitializeComponent()
    {
        ...
        System.ComponentModel.ComponentResourceManager resources =
            new System.ComponentModel.ComponentResourceManager(typeof(DbNavigator));
        ...
        this._navigationToolbar.Buttons.AddRange(
        ...
        this._navigationToolbar.ButtonClick +=
            new System.Windows.Forms.ToolBarButtonClickEventHandler(this.OnButtonClick);
        //
        // _moveFirstButton
        //
        ...
        // _navigatorImageList
        //
        this._navigatorImageList.ImageStream = (
            (System.Windows.Forms.ImageListStreamer)(
                resources.GetObject("_navigatorImageList.ImageStream")
            )
        );
        ...
        this._addDeleteToolbar.Buttons.AddRange(
            new System.Windows.Forms.ToolBarButton[] { this._newButton, this._deleteButton }
        );
        ...
        this._addDeleteToolbar.ButtonClick +=
            new System.Windows.Forms.ToolBarButtonClickEventHandler(this.OnButtonClick);
        //
        // _recordLabel
        //
    ...
    public void UpdateControls()
    {
        ...
        if (bindMan == null || bindMan.Position < 0 || isBinding == false)
        {
            _moveFirstButton.Enabled =
                _movePreviousButton.Enabled =
                _moveLastButton.Enabled =
                _moveNextButton.Enabled =
                _deleteButton.Enabled =
                    false; //_endEdit.Enabled =false;
