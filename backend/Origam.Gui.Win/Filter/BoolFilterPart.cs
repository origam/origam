...
{
    #region Constructor
    public BoolFilterPart(
        AsCheckBox filteredControl,
        Type dataType,
        string dataMember,
    ...
    {
        get { return new FilterOperator[] { FilterOperator.Equals }; }
    }
