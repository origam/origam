...
{
    #region Constructor
    public DateFilterPart(
        AsDateBox filteredControl,
        Type dataType,
        string dataMember,
    ...
    {
        get { return FilterOperator.GreaterOrEqualThan; }
    }
    ...
    public override void CreateFilterControls()
    {
        ...
        this.FilterDateBox2.Tag = (
            this.Operator == FilterOperator.Between | this.Operator == FilterOperator.NotBetween
        );
        SubscribeEvents();
        OnControlsChanged();
    }
