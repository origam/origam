                ...
                try
                {
                    try
                    {
                        transaction = service.CreateTransaction(
                            "OnAddCollapsiblePanel: " + base.Component.Site.Name
                        );
                    ...
                    CollapsiblePanel page = (CollapsiblePanel)
                        service.CreateComponent(typeof(CollapsiblePanel));
                    string str = null;
            ...
            if ((component != null) && (component.TabPages.Count != 0))
            {
                ...
                if (service != null)
                {
                    ...
                    try
                    {
                        ...
                        {
                            transaction = service.CreateTransaction(
                                "CollapsibleContainerRemovePanel: "
            ...
            for (int i = 0; i < strArray.Length; i++)
            {
                ...
                if (oldPropertyDescriptor != null)
                {
                    properties[strArray[i]] = TypeDescriptor.CreateProperty(
                        typeof(CollapsibleContainerDesigner),
