...
public class AsTabControl : System.Windows.Forms.TabControl
{
	...
	protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
	{
			...
			switch (this.SelectedIndex) 
			{
				...
				case 0:
					...
					e.Graphics.DrawLine(new Pen(OrigamColorScheme.TabActiveEndColor), selrect.Left + 2, selrect.Bottom + 1, selrectRight - 2, selrect.Bottom + 1);
					break;
				default:
					selrect = this.GetTabRect(this.SelectedIndex);
					selrectRight = selrect.Right;
					e.Graphics.DrawLine(new Pen(OrigamColorScheme.TabActiveEndColor), selrect.Left + 6 - selrect.Height, selrect.Bottom + 1, selrectRight - 2, selrect.Bottom + 1);
					break;
			}
		}
	...
	private void PaintTabBackground(System.Drawing.Graphics graph, int index, System.Drawing.Drawing2D.GraphicsPath path)
	{
			...
			if (rect.Height > 1 && rect.Width > 1)
			{
				...
				if (index == this.SelectedIndex)
				{
					buttonBrush = new System.Drawing.Drawing2D.LinearGradientBrush(rect, OrigamColorScheme.TabActiveStartColor, OrigamColorScheme.TabActiveEndColor, LinearGradientMode.Vertical);
				}
				else
				{
					buttonBrush = new System.Drawing.Drawing2D.LinearGradientBrush(rect, OrigamColorScheme.TabInactiveStartColor, OrigamColorScheme.TabInactiveEndColor, LinearGradientMode.Vertical);
				}
