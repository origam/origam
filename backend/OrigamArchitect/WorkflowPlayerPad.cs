...
public class WorkflowPlayerPad : AbstractPadContent, IBrowserPad
{
    ...
    private void InitializeComponent()
    {
        ...
        this.ebrSchemaBrowser.NodeDoubleClick += new System.EventHandler(
            this.ebrSchemaBrowser_NodeDoubleClick
        );
        this.ebrSchemaBrowser.QueryFilterNode += new FilterEventHandler(
            ebrSchemaBrowser_QueryFilterNode
        );
        //
        // WorkflowPlayerPad
        //
    ...
    {
        get { return ebrSchemaBrowser.imgList; }
    }
