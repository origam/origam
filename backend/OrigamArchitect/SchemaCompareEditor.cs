...
public class SchemaCompareEditor : AbstractViewContent
{
    ...
    private void InitializeComponent()
    {
        System.ComponentModel.ComponentResourceManager resources =
            new System.ComponentModel.ComponentResourceManager(typeof(SchemaCompareEditor));
        this.colType = (
        ...
        this.lvwResults.Columns.AddRange(
            new System.Windows.Forms.ColumnHeader[] { this.colType, this.colName, this.colRemark }
        );
        ...
        this.cboDatabaseType.SelectedIndexChanged += new System.EventHandler(
            this.CboDatabaseType_SelectedIndexChanged
        );
        //
        // btnAddToModel
        //
    ...
    {
        btnAddToDeployment.Visible = IsModeMissingInDatabase() || IsModeExistingButDifferent();
        btnAddToModel.Visible = IsModeMissingInSchema();
        groupBox2.Visible = IsModeMissingInDatabase() || IsModeExistingButDifferent();
        try
        {
