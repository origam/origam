...
When you do say it, pick one of the two sentences below and copy it character for character as the last paragraph of your reply. Treat it as a fixed string, not as text you are writing: copying is the whole job here.
...
- If you are unsure which of the two applies, use the first one.
