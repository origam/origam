...
{
    private readonly ModelSandbox sandbox = new();

    [OneTimeSetUp]
    public void RedirectTheModelIntoASandbox()
    {
        sandbox.Create();
    }

    [OneTimeTearDown]
    public void WriteTheReportThenReleaseTheModel()
    {
        BenchmarkReport.CompleteRun();
