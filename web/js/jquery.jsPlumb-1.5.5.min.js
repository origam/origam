...
-1 == jsPlumbUtil.findWithFunction(a, c) && a.push(b)
        ...
        extend: function (b, c, d, e) {
            ...
            for (var f = 0; f < c.length; f++)
                for (var g in c[f].prototype)
                    c[f].prototype.hasOwnProperty(g) && (b.prototype[g] = c[f].prototype[g]);
            var h = function (a) {
                return function () {
                    for (var b = 0; b < c.length; b++)
                        c[b].prototype[a] && c[b].prototype[a].apply(this, arguments);
    ...
    var a = !!document.createElement("canvas").getContext, b = !!window.SVGAngle || document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1"), c = function () {
        ...
        var a = jsPlumbUtil, b = function (a, b) {
        ...
        }, j = ["click", "dblclick", "mouseenter", "mouseout", "mousemove", "mousedown", "mouseup", "contextmenu"], k = {
            mouseout: "mouseexit"
        }, l = function (a, b, c, d) {
            ...
            if (this._jsPlumb = {
                ...
                return f
            }, b.events) for (var h in b.events)
                c.bind(h, b.events[h]);
            this.clone = function () {
                var a = {};
...
-1 != g ? this._jsPlumb.types.splice(g, 1) : this._jsPlumb.types.push(d[e])
        ...
        var p = "__label", q = function (a, b) {
            ...
            if (a.isArray(c)) {
                ...
                d = c.constructor == String ? new (y.Overlays[b._jsPlumb.instance.getRenderMode()][c])({
                    component: b,
                    _jsPlumb: b._jsPlumb.instance
                }) : c;
        ...
        var v = 0, w = function () {
            ...
            var r = null, s = !1, t = [], u = {}, v = {}, x = {}, z = {}, A = {}, B = {}, C = !1, D = [], E = !1, F = null, G = this.Defaults.Scope, H = null, I = 1, J = function () {
                ...
                if (!jsPlumbAdapter.headless && !E) {
                    ...
                    if (j.anchorManager.redraw(e, b, c, null, d), f)
                        for (var k in f)
                            j.anchorManager.redraw(f[k].id, b, c, f[k].offset, d, !0)
                }
            }, N = function (b, c) {
                var e, f, g = null;
                if (a.isArray(b)) {
                    ...
                    if (g && h.isDragSupported(d) && !h.isAlreadyDraggable(d)) {
                        ...
                        i[m] = a.wrap(i[m], function () {
                            j.setHoverSuspended(!0), j.select({
                                source: d
                            }).addClass(j.elementDraggingClass + " " + j.sourceElementDraggingClass, !0), j.select({
                                target: d
                            }).addClass(j.elementDraggingClass + " " + j.targetElementDraggingClass, !0), j.setConnectionBeingDragged(!0)
                        }), i[k] = a.wrap(i[k], function () {
                            var a = h.getUIPosition(arguments, j.getZoom());
                            M(d, a, null, !0), b(d, "jsPlumb_dragged")
                        }), i[l] = a.wrap(i[l], function () {
                            var a = h.getUIPosition(arguments, j.getZoom());
                            M(d, a), c(d, "jsPlumb_dragged"), j.setHoverSuspended(!1), j.select({
                                source: d
                            }).removeClass(j.elementDraggingClass + " " + j.sourceElementDraggingClass, !0), j.select({
                                target: d
                            }).removeClass(j.elementDraggingClass + " " + j.targetElementDraggingClass, !0), j.setConnectionBeingDragged(!1), j.dragManager.dragEnded(d)
                        });
                        var n = bb(d);
                        B[n] = !0;
                        var o = B[n];
                ...
                var d = y.extend({}, b);
                if (c && y.extend(d, c), d.source && (d.source.endpoint ? d.sourceEndpoint = d.source : d.source = e(d.source)
                ), d.target && (d.target.endpoint ? d.targetEndpoint = d.target : d.target = e(d.target)), b.uuids && (d.sourceEndpoint = O(b.uuids[0]), d.targetEndpoint = O(b.uuids[1])), d.sourceEndpoint && d.sourceEndpoint.isFull()) return a.log(j, "could not add connection; source endpoint is full"), void 0;
                if (d.targetEndpoint && d.targetEndpoint.isFull())
                    return a.log(j, "could not add connection; target endpoint is full"), void 0;
                ...
                if (b = b || {}, a.suspendedEndpoint || t.push(a)
                , (null == a.suspendedEndpoint || d) && j.anchorManager.newConnection(a), M(a.source), !b.doNotFireConnectionEvent && b.fireEvent !== !1) {
                    var e = {
                        connection: a,
                        source: a.source,
                        target: a.target,
            ...
            this.setConnectionBeingDragged = function (a) {
                ...
                svg: {},
                vml: {}
            }, this.ConnectorRenderers = {}, this.SVG = "svg", this.CANVAS = "canvas", this.VML = "vml", this.addEndpoint = function (b, c, d) {
                d = d || {};
                var f = y.extend({}, d);
            ...
            this.unregisterEndpoint = function (a) {
                ...
                if (0 !== arguments.length) {
                    var a = j.Defaults.ConnectionType || j.getDefaultConnectionType(), b = arguments[0].constructor == a, c = 2 == arguments.length ? b ? arguments[1] || {}
                ...
                var b = {
                    ...
                    endpointCount: 0,
                    connectionCount: 0
                }, c = a.fireEvent !== !1, d = a.deleteAttachedObjects !== !1, e = function (a) {
            ...
            this.registerConnectorType = function (a, b) {
                ...
                if ("string" == typeof d)
                    ...
                    if (a.isArray(d[0]) || a.isString(d[0]))
                        2 == d.length && a.isObject(d[1]) ? a.isString(d[0]) ? (b = y.extend({
                            elementId: e,
                            jsPlumbInstance: j
                            ...
                            jsPlumbInstance: j,
                            anchors: d[0]
                        }, d[1]), g = new y.DynamicAnchor(b)) : g = new y.DynamicAnchor({
                            anchors: d,
                            selector: null,
                            elementId: e,
                            jsPlumbInstance: f
            ...
            var tb = {}, ub = {}, vb = {}, wb = {}, xb = function (a, b) {
                ...
                for (var d = a.target || a.srcElement, e = !1, f = j.getSelector(b, c)
                , g = 0;
            g < f.length;
            g++) if (f[g] == d) {
                    e = !0;
            ...
            this.makeTarget = function (b, c, e) {
                ...
                var i = y.CurrentLibrary, k = h.scope || j.Defaults.Scope, l = !(h.deleteEndpointsOnDetach === !1), m = h.maxConnections || -1, n = h.onMaxConnections, q = function (b) {
                    ...
                    var s = function () {
                        ...
                        var a = y.CurrentLibrary.getDropEvent(arguments), b = j.select({
                            target: e
                        }).length, k = d(i.getDragObject(arguments)), m = j.getAttribute(k, "dragId"), o = j.getAttribute(k, "originalScope"), p = A[m], r = p.endpoints[0].isFloating() ? 0 : 1, s = p.endpoints[0];
                        if (h.endpoint ? y.extend({}, h.endpoint) : {}, !Eb[e] || wb[e] > 0 && b >= wb[e])
                            return n && n({
                                element: c.el,
                                connection: p
                            }, a), !1;
                        if (s.anchor.locked = !1, o && i.setDragScope(k, o)
                        , null == p.suspendedEndpoint && !p.pending) return !1;
                        ...
                        if (p.suspendedEndpoint && (p[r ? "targetId" : "sourceId"] = p.suspendedEndpoint.elementId, p[r ? "target" : "source"] = p.suspendedEndpoint.element, p.endpoints[r] = p.suspendedEndpoint), t) {
                            ...
                            if ((null == v || null == v._jsPlumb) && (v = j.addEndpoint(u, h)), h.uniqueEndpoint && (ub[e] = v)
                            , v._doNotDeleteOnDetach = !1, v._deleteOnDetach = !0, null != v.anchor.positionFinder) {
                            ...
                            p.suspendedEndpoint && (p.isReattach() ? (p.setHover(!1), p.floatingAnchorIndex = null, p.suspendedEndpoint.addConnection(p), j.repaint(s.elementId)) : s.detach(p, !1, !0, !0, a))
                    }, t = i.dragEvents.drop;
                ...
                var i = y.extend({}, h);
                y.extend(i, c), xb(i, 0);
                var k = y.CurrentLibrary, l = i.maxConnections || -1, m = i.onMaxConnections, n = function (b) {
                    var c = b.id, h = d(b.el), n = function () {
                        return null == i.parent ? null : "parent" === i.parent ? b.el.parentNode : e(i.parent)
                    }, o = null != i.parent ? j.getId(n()) : c;
                    yb[o] = i, Ab[o] = i.uniqueEndpoint, Bb[o] = !0;
                    var p = k.dragEvents.stop, q = k.dragEvents.drag, r = y.extend({}, i.dragOptions || {}), s = r.drag, t = r.stop, u = null, v = !1;
                    Db[o] = l, r.scope = r.scope || i.scope, r[q] = a.wrap(r[q], function () {
                        ...
                        if (t && t.apply(this, arguments), j.currentlyDragging = !1, null != u._jsPlumb) {
                            ...
                            var a = i.anchor || j.Defaults.Anchor, b = u.anchor, d = u.connections[0], e = j.makeAnchor(a, c, j), h = u.element;
                            if (null != e.positionFinder) {
                                var l = f(h, j), m = g(h), o = {
                                    left: l.left + b.x * m[0],
                                    top: l.top + b.y * m[1]
                                }, p = e.positionFinder(o, l, m, e.constructorParams);
                                e.x = p[0], e.y = p[1]
                            }
                            if (u.setAnchor(e, !0), i.parent) {
                                var q = n();
                                if (q) {
                                    var r = i.container || j.Defaults.Container || y.Defaults.Container;
                                    u.setElement(q, r)
                                }
                            }
                            u.repaint(), j.repaint(u.elementId), j.repaint(d.targetId)
                        }
                    });
                    var w = function (a) {
                        if (Bb[o]) {
                            if (i.filter) {
                                var b = k.getOriginalEvent(a), d = jsPlumbUtil.isString(i.filter) ? Fb(b, h, i.filter) : i.filter(b, h);
                                if (d === !1)
                                    return
                            }
                            var e = j.select({
                            ...
                            var f = _({
                                elId: c
                            }).o, g = j.getZoom(), p = ((a.pageX || a.page.x) / g - f.left) / f.width, q = ((a.pageY || a.page.y) / g - f.top) / f.height, s = p, t = q;
                            if (i.parent) {
                                var w = n(), x = bb(w);
                                f = _({
                                    elId: x
                                }).o, s = ((a.pageX || a.page.x) - f.left) / f.width, t = ((a.pageY || a.page.y) - f.top) / f.height
                            }
                            var z = {};
                            if (y.extend(z, i), z.isSource = !0, z.anchor = [p, q, 0, 0], z.parentAnchor = [s, t, 0, 0], z.dragOptions = r, i.parent) {
                                var A = z.container || j.Defaults.Container || y.Defaults.Container;
                                z.container = A ? A : y.CurrentLibrary.getParent(n())
                            }
                            u = j.addEndpoint(c, z), v = !0, u.endpointWillMoveAfterConnection = null != i.parent, u.endpointWillMoveTo = i.parent ? n() : null, u._doNotDeleteOnDetach = !1, u._deleteOnDetach = !0;
                            var B = function () {
                                v && (v = !1, j.deleteEndpoint(u))
                            };
                            j.registerListener(u.canvas, "mouseup", B), j.registerListener(h, "mouseup", B), k.trigger(u.canvas, "mousedown", a)
                        }
                    };
                    j.registerListener(h, "mousedown", w), Cb[c] = w, i.filter && jsPlumbUtil.isString(i.filter) && k.setDragFilter(h, i.filter)
                };
                b = L(b);
            ...
            this.toggleSourceEnabled = function (a) {
                ...
                var c = function (a) {
                    ...
                    if (delete u[f.id], b && f.el && 3 != f.el.nodeType && 8 != f.el.nodeType)
            ...
            this.initDraggable = function () {
                if (!v && i.isDragSupported(this.element)) {
                    var d = {
                        ...
                        , this.isSource && this.isFull() && !this.dragAllowedWhenFull && (a = !1), null == e || e.isDetachable() || (a = !1), a === !1) return i.stopDrag && i.stopDrag(), o.stopDrag(), !1;
                        ...
                        this.addClass("endpointDrag"), h.setConnectionBeingDragged(!0), e && !this.isFull() && this.isSource && (e = null), h.updateOffset({
                            elId: this.elementId
                        }), r = this.makeInPlaceCopy(), r.referenceEndpoint = this, r.paint(), b(d, this.parent, h);
                        ...
                        ), h.setAttribute(this.canvas, "dragId", d.id), h.setAttribute(this.canvas, "elId", this.elementId), this._jsPlumb.floatingEndpoint = c(this.getPaintStyle(), this.anchor, this.endpoint, this.canvas, d.element, h, n), this.canvas.style.visibility = "hidden", null == e) this.anchor.locked = !0, this.setHover(!1, !1), e = m({
                            sourceEndpoint: this,
                    ...
                    s = jsPlumb.extend(t, s), s.scope = s.scope || this.scope, s[u] = l.wrap(s[u], p, !1), s[y] = l.wrap(s[y], o.drag), s[x] = l.wrap(s[x], function () {
                        ...
                        h.remove(d.element, !1), h.remove(r.canvas, !1), this.deleteAfterDragStop ? h.deleteObject({
                            endpoint: this
                            ...
                            if (this.isFull() && this.fire("maxConnections", {
                                ...
                                var n = function () {
                                    ...
                                    if (f.suspendedEndpoint) {
                                        ...
                                        p({
                                            index: k,
                                            originalSourceId: 0 === k ? d : f.sourceId,
                                            newSourceId: 0 === k ? this.elementId : f.sourceId,
                                            originalTargetId: 1 == k ? d : f.targetId,
                                            newTargetId: 1 == k ? this.elementId : f.targetId,
                                            originalSourceEndpoint: 0 === k ? f.suspendedEndpoint : f.endpoints[0],
                                            newSourceEndpoint: 0 === k ? this : f.endpoints[0],
                                            originalTargetEndpoint: 1 == k ? f.suspendedEndpoint : f.endpoints[1],
                                            newTargetEndpoint: 1 == k ? this : f.endpoints[1],
                                            connection: f
                                        }, a)
                                    } else
                                        b.draggable && jsPlumb.CurrentLibrary.initDraggable(this.element, dragOptions, !0, h);
        ...
        var a = function (a, b, c, d) {
            ...
            if (e)
                ...
                }), d.endpoints[f] = l, g.drawEndpoints === !1 && l.setVisible(!1, !0, !0)
            }
            return l
        };
        jsPlumb.Connection = function (a) {
            ...
            if (g.updateOffset({
                ...
                elId: this.targetId, timestamp: j
            })
            , !g.isSuspendDrawing()) {
                var k = g.getCachedData(this.sourceId), l = k.o, m = k.s, n = g.getCachedData(this.targetId), o = n.o, p = n.s, q = j || g.timestamp(), r = this.endpoints[0].anchor.compute({
                    xy: [l.left, l.top],
                    wh: m,
            ...
            var t = [a.type, this.endpoints[0].connectionType, this.endpoints[1].connectionType].join(" ");
            ...
            moveParent: function (a) {
                ...
                for (var c = 0; c < this._jsPlumb.overlays.length; c++)
                    this._jsPlumb.overlays[c].isAppendedAtTopLevel && (b.removeElement(this._jsPlumb.overlays[c].canvas), b.appendElement(this._jsPlumb.overlays[c].canvas, a), this._jsPlumb.overlays[c].reattachListeners && this._jsPlumb.overlays[c].reattachListeners(this.connector));
            ...
            setConnector: function (b, c) {
                ...
                d.isString(b) ? this.connector = a(this._jsPlumb.instance, f, b, e) : d.isArray(b) && (this.connector = 1 == b.length ? a(this._jsPlumb.instance, f, b[0], e) : a(this._jsPlumb.instance, f, b[0], d.merge(b[1], e))), this.bindListeners(this.connector, this, function (a) {
                    this.setHover(a, !1)
                } .bind(this)), this.canvas = this.connector.canvas, this._jsPlumb.editable && null != jsPlumb.ConnectorEditors && jsPlumb.ConnectorEditors[this.connector.type] && this.connector.isEditable() ? new jsPlumb.ConnectorEditors[this.connector.type]({
        ...
        jsPlumb.AnchorManager = function (a) {
            var b = {}, c = {}, d = {}, e = {}, f = {}, g = {
                ...
                DIAGONAL: "diagonal",
                IDENTITY: "identity"
            }, h = {}, i = this, j = {}, k = a.jsPlumbInstance, l = jsPlumb.CurrentLibrary, m = {}, n = function (a, b, c, d, e, f) {
                if (a === b)
                    return {
                ...
                var c = k.getCachedData(a), e = c.s, g = c.o, h = function (b, c, e, g, h, i, j) {
                    if (g.length > 0)
                        for (var l = s(g, r[b]), m = "right" === b || "top" === b, n = o(b, c, e, l, h, i, m), p = function (a, b) {
...
-1 != e && (h[a][e][0] = d, h[a][e][1] = d.endpoints[1], h[a][e][2] = d.endpoints[1].anchor.constructor == jsPlumb.DynamicAnchor), f > -1 && (h[b].splice(f, 1), jsPlumbUtil.addToList(h, c, [d, d.endpoints[0], d.endpoints[0].anchor.constructor == jsPlumb.DynamicAnchor]))
                ...
                if (!k.isSuspendDrawing()) {
                    ...
                    for (u = 0; u < i.length; u++)
                        0 === i[u].connections.length && i[u].anchor.isContinuous && (j[a] || (j[a] = {
                            top: [],
                            right: [],
                            bottom: [],
                            left: []
                        }), v(j[a], -Math.PI / 2, 0, {
                            endpoints: [i[u], i[u]], paint: function () { }
                    ...
                    for (u = 0; u < l.length; u++) {
                        ...
                        if (H.anchor.constructor == jsPlumb.DynamicAnchor) {
                            H.paint({
                                ...
                                timestamp: d
                            }), jsPlumbUtil.addWithFunction(o, l[u][0], function (a) {
                                return a.id == l[u][0].id
                            });
                            for (var I = 0; I < H.connections.length; I++)
                                H.connections[I] !== l[u][0] && jsPlumbUtil.addWithFunction(o, H.connections[I], function (a) {
                                    return a.id == H.connections[I].id
                                })
                        } else
                            H.anchor.constructor == jsPlumb.Anchor && jsPlumbUtil.addWithFunction(o, l[u][0], function (a) {
                                return a.id == l[u][0].id
                            })
                    }
                    var J = m[a];
        ...
        jsPlumb.DOMElementComponent = jsPlumbUtil.extend(jsPlumb.jsPlumbUIComponent, function () {
            ...
            Straight: function (a) {
                var b, c, d, e, f, g, h, i = (jsPlumb.Segments.AbstractSegment.apply(this, arguments), function () {
                    b = Math.sqrt(Math.pow(f - e, 2) + Math.pow(h - g, 2)), c = jsPlumbGeom.gradient({
                        x: e,
                        y: g
                    }, {
                        x: f,
                ...
                this.findClosestPointOnPath = function (a, i) {
                    ...
                    return l.d = jsPlumbGeom.lineLength([a, i], [l.x, l.y]), l.l = q / b, l
                }
            },
            Arc: function (a) {
            ...
            this.computeMaxSize = function () {
                ...
                if (a.pointAlongPathFrom) {
                    if (b.isString(this.loc) || this.loc > 1 || this.loc < 0) {
                        ...
                        , j = c.pointOnLine(h, i, this.length), -1 == d) {
                            var o = j;
                            j = h, h = o
                        }
                    } else if (0 === this.loc) {
                        if (j = a.pointOnPath(this.loc), i = a.pointAlongPathFrom(this.loc, this.length)
                        , h = c.pointOnLine(j, i, this.length), -1 == d) {
                            var p = j;
                            j = h, h = p
                        }
                    } else
                        h = a.pointAlongPathFrom(this.loc, d * this.length / 2), i = a.pointOnPath(this.loc), j = c.pointOnLine(h, i, this.length);
                    k = c.perpendicularLineTo(h, j, this.width), l = c.pointOnLine(h, j, g * this.length);
                    var q = {
                        hxy: h,
                        tail: k,
                        cxy: l
                    }, r = f.strokeStyle || e.strokeStyle, s = f.fillStyle || e.strokeStyle, t = f.lineWidth || e.lineWidth, u = {
                        component: a,
                        d: q,
                        lineWidth: t,
                        strokeStyle: r,
            ...
            this.id = a.id, this._jsPlumb.div = null, this._jsPlumb.initialised = !1, this._jsPlumb.component = a.component, this._jsPlumb.cachedDimensions = null, this._jsPlumb.create = a.create, this.getElement = function () {
                ...
                if (null != d && 2 == d.length) {
                    ...
                    if (c)
                        ...
                        var g = this.loc, h = !1;
                        (jsPlumbUtil.isString(this.loc) || this.loc < 0 || this.loc > 1) && (g = parseInt(this.loc, 10), h = !0), e = a.pointOnPath(g, h)
                    } else {
        ...
        var j = [null, [1, -1], [1, 1], [-1, 1], [-1, -1]], k = function (a, b, c) {
            ...
            this.canvas = h({
                ...
                parent: a.parent
            }), this.ctx = this.canvas.getContext("2d"), this.appendDisplayElement(this.canvas), this.paint = function (a, c, d) {
                if (null != a) {
                    var e = [this.x, this.y], f = [this.w, this.h], g = 0, h = 0;
                    if (null != d && (d.xmin < 0 && (e[0] += d.xmin, g = -d.xmin), d.ymin < 0 && (e[1] += d.ymin, h = -d.ymin), f[0] = d.xmax + (d.xmin < 0 ? -d.xmin : 0)
                    , f[1] = d.ymax + (d.ymin < 0 ? -d.ymin : 0)), this.translateX = g, this.translateY = h, jsPlumbUtil.sizeElement(this.canvas, e[0], e[1], f[0], f[1]), null != a.outlineColor) {
        ...
        jsPlumbUtil.extend(n, i), jsPlumb.Endpoints.canvas.Dot = function (a) {
            ...
            this._paint = function (c) {
                if (null != c) {
                    ...
                    if (jsPlumb.extend(e, c), c.gradient) {
                        for (var g = d(c.gradient), h = 1 == f[1] ? -1 * g[0] : g[0], i = 1 == f[0] ? -1 * g[0] : g[0], j = e.createRadialGradient(b.radius, b.radius, b.radius, b.radius + i, b.radius + h, g[1])
                        , k = 0;
                    k < c.gradient.stops.length;
                    k++) j.addColorStop(c.gradient.stops[k][0], c.gradient.stops[k][1]);
                        e.fillStyle = j
                    }
            ...
            jsPlumb.Endpoints.Rectangle.apply(this, arguments), n.apply(this, arguments), this._paint = function (c) {
                ...
                if (jsPlumb.extend(d, c), c.gradient) {
                    for (var f = 1 == e[1] ? b.h : 0 === e[1] ? b.h / 2 : 0, g = -1 == e[1] ? b.h : 0 === e[1] ? b.h / 2 : 0, h = 1 == e[0] ? b.w : 0 === e[0] ? b.w / 2 : 0, i = -1 == e[0] ? b.w : 0 === e[0] ? b.w / 2 : 0, j = d.createLinearGradient(h, f, i, g)
                    , k = 0;
                k < c.gradient.stops.length;
                k++) j.addColorStop(c.gradient.stops[k][0], c.gradient.stops[k][1]);
                    d.fillStyle = j
        ...
        var a = {
            ...
            for (var b = 0; b < a.childNodes.length; b++) (a.childNodes[b].tagName == d || a.childNodes[b].tagName == e)
            ...
            for (var o = 0; o < c.gradient.stops.length; o++) {
                var q = 1 == k.segment || 2 == k.segment ? o : c.gradient.stops.length - 1 - o, s = jsPlumbUtil.convertStyle(c.gradient.stops[q][1], !0), t = p(g, {
            ...
            if (g.gradient ? s(d, e, g, l, n) : (r(d), e.setAttribute(j, ""))
            , e.setAttribute(f, g.fillStyle ? jsPlumbUtil.convertStyle(g.fillStyle, !0) : k), e.setAttribute(h, g.strokeStyle ? jsPlumbUtil.convertStyle(g.strokeStyle, !0) : k), g.lineWidth && e.setAttribute(i, g.lineWidth), g[c] && g[m] && !g[b]) {
...
-1 != h && f.splice(h, 1)
        ...
        var y = function (a) {
            ...
            this.svg = p("svg", e), a.useDivWrapper ? (this.canvas = document.createElement("div"), this.canvas.style.position = "absolute", jsPlumbUtil.sizeElement(this.canvas, 0, 0, 1, 1), this.canvas.className = d) : (o(this.svg, {
                "class": d
            ...
            return this.getDisplayElements = function () {
                ...
                if (null != b) {
                    ...
                    null != e && (e.xmin < 0 && (g[0] += e.xmin), e.ymin < 0 && (g[1] += e.ymin), h[0] = e.xmax + (e.xmin < 0 ? -e.xmin : 0), h[1] = e.ymax + (e.ymin < 0 ? -e.ymin : 0)), a.useDivWrapper ? (jsPlumbUtil.sizeElement(this.canvas, g[0], g[1], h[0], h[1]), g[0] = 0, g[1] = 0, f = q([0, 0])) : f = q([g[0], g[1]]), c.paint.apply(this, arguments), o(this.svg, {
                        style: f,
                        width: h[0],
                        height: h[1]
                    })
        ...
        var A = function (a, b) {
            a.apply(this, b), jsPlumb.jsPlumbUIComponent.apply(this, b), this.isAppendedAtTopLevel = !1, this.path = null, this.paint = function (a, d) {
                if (a.component.svg && d) {
                    ...
                    d.xmin < 0 && (f[0] = -d.xmin), d.ymin < 0 && (f[1] = -d.ymin), o(this.path, {
                        d: c(a.d),
                        "class": e,
        ...
        jsPlumbUtil.extend(A, [jsPlumb.jsPlumbUIComponent, jsPlumb.Overlays.AbstractOverlay], {
            cleanup: function () {
            ...
            jsPlumb.Overlays.GuideLines.apply(this, arguments), this.paint = function (f, g) {
                ...
                var h = [0, 0];
                g.xmin < 0 && (h[0] = -g.xmin), g.ymin < 0 && (h[1] = -g.ymin), o(c, {
                    d: e(f.head, f.tail),
                    stroke: "red",
                    fill: null,
                    transform: "translate(" + h[0] + "," + h[1] + ")"
