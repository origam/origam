...
export class DropdownEditorTable extends  React.Component<{
  ...
  constructor(props: any) {
    ...
    this.rowCount = this.props.dataTable.rowCount + (this.hasHeader ? 1 : 0);
  }
  ...
  componentDidMount() {
    for (let i = 0; i < this.rowCount; i++) {
      this.height = this.height + rowHeight;
    }
    this.height = Math.min(this.height, 300) + this.scrollbarSize.horiz;
