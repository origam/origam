...
test("Should replace duplicate rows", () => {
  ...
  expect(getTestValue(scrollContainer.rowChunks[0].getRow("1"))).toBe(
    "original",
  );
  expect(getTestValue(scrollContainer.rowChunks[0].getRow("2"))).toBe(
    "duplicate",
  );
  expect(getTestValue(scrollContainer.rowChunks[0].getRow("3"))).toBe(
    "original",
  );
  expect(getTestValue(scrollContainer.rowChunks[1].getRow("4"))).toBe(
    "original",
  );
  expect(getTestValue(scrollContainer.rowChunks[1].getRow("5"))).toBe(
    "original",
  );
  expect(getTestValue(scrollContainer.rowChunks[1].getRow("6"))).toBe(
    "duplicate",
  );
