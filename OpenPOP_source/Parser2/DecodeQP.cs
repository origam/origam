...
namespace NandoF.Mail.Parser2
{
	...
	public class DecodeQP
	{
		...
		static public string ConvertHexToString(string Hexstring,string Encoding)
		{
			try  {
		...
		/// <param name="encode">encoding method</param>
		/// <returns>decoded string</returns>
		static public string ConvertHexToString(string Hexstring,Encoding encode)
		{			
			try
			{
		...
		/// <returns>decoded string</returns>
		static public string ConvertHexContent(string Hexstring,Encoding encode,long nStart)
		{			
		...
		/// <summary>Decoding Quoted-Printable string using default encoding and
		/// begin at 0</summary>
		/// <param name="Hexstring">Quoted-Printable encoded string</param>
		/// <returns>decoded string</returns>
		static public string ConvertHexContent(string Hexstring)
		{
