...
test.describe('Create Screen from Screen Section wizard (real backend)', () => {
  ...
  test('Create Screen from Screen Section', async ({ page }) => {
    ...
    await dialog.getByRole('textbox').fill('DimensionEntityRelationScreen');
    ...
    await expect(
      page.getByRole('cell', { name: 'DimensionEntityRelationScreen' }).first(),
    ).toBeVisible();
